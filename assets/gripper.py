...
class Gripper():
    ...
    def save_angle(self):
        self.old_angle = self._get_angle()
    
    def gr_closed(self, angle_THOLD=0.776):
        return self._get_angle()>angle_THOLD # 0.8rad is about 0.001m opening length


    def _get_opening_length(self):
